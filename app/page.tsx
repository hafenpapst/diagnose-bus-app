...
const cases = [
  {
    ...
    text: "Porsche Cayenne macht Probleme.",
    color: "red",
  },
  {
    id: 2,
    ...
    text: "Da Passat was nicht mit meinem Auto.",
    color: "amber",
  },
  {
    id: 3,
    ...
    text: "So fahre ich nie wieder in die Waschsstraße.",
    color: "blue",
  },
  {
    id: 4,
    ...
    text: "Wenn die Fahrt zum Bäcker mal wieder etwas länger dauert.",
    color: "emerald",
  },
{
  id: 5,
  ...
  text: "Wer braucht schon Regen wenn die Sonne scheint.",
  color: "violet",
},
];
