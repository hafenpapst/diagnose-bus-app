...
if (caseId !== "1" && caseId !== "2" && caseId !== "3") {
  ...
  <>
    <div className="relative">
      <img
        src="/images/problem1_schaltplan1.png"
        alt="Schaltplan Problem 1 Seite 1"
        className="w-full"
      />
    </div>
    ...
    <div className="relative mt-6">
      <img
        src="/images/problem1_schaltplan2.png"
        alt="Schaltplan Problem 1 Seite 2"
        className="w-full"
      />
    </div>
  </>
        ...
        {caseId === "2" && (
          <>
            <div className="relative">
              <img
                src="/images/problem2_schaltplan1.png"
                alt="Schaltplan Problem 2 Seite 1"
                className="w-full"
              />
            </div>
            ...
            <div className="relative mt-6">
              <img
                src="/images/problem2_schaltplan2.png"
                alt="Schaltplan Problem 2 Seite 2"
                className="w-full"
              />
            </div>
          </>
        ...
        {caseId === "3" && (
          <>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <p className="font-bold text-blue-300">
                          J387 / T20h/20 gemessen gegen Kl.31
                        </p>
            ...
            <div className="relative mt-6">
              ...
              {/* J926 T20l/20 Spannungsversorgung */}
              <button
